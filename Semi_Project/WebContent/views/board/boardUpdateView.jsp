...
<%@ include file="../common/header1.jsp"%>
	<div class="wrap">
		...
		<form action="/javajo/update.fb" id="enroll-form" method="post"	enctype="multipart/form-data">
			...
			<div id="board-body">
				...
				<div id="board-center">
					...
					<%= at.getOriginName() %>
                    	...
                    	<%} %>
						<input type="file" id="file1" name="file1 reUpfile" onchange="loadImg(this,1)"> 
